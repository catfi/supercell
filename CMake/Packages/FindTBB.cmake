...
if (WIN32)
    ...
    set(_TBB_DEFAULT_INSTALL_DIR "${CMAKE_SOURCE_DIR}/dep/windows/tbb/tbb30_20100406oss" "C:/Program Files (x86)/Intel/TBB")
...
if (TBB_INCLUDE_DIR)
    if (TBB_LIBRARY)
        ...
        message(STATUS "Found Intel TBB. include path: ${TBB_INCLUDE_DIR}")
    endif (TBB_LIBRARY)
